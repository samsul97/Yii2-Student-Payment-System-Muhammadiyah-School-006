...
/**
 * MpLocationSearch represents the model behind the search form of `backend\models\MpLocation`.
 */
class MpLocationSearch extends MpLocation
{
    /**
     * {@inheritdoc}
     */
